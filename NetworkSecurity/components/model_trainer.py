...
import dagshub
dagshub.init(repo_owner='Punit-7',
             repo_name='NetworkSecurityProject', mlflow=True)

os.environ["MLFLOW_TRACKING_URI"] = "https://dagshub.com/Punit-7/NetworkSecurityProject.mlflow"
os.environ["MLFLOW_TRACKING_USERNAME"] = "Punit-7"
os.environ["MLFLOW_TRACKING_PASSWORD"] = "99dc69bd02fe246c5b636f344d0cdbb0ebb526ce"
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, best_model_name, classificationmetric):
        mlflow.set_registry_uri(
            "https://dagshub.com/Punit-7/NetworkSecurityProject.mlflow")
